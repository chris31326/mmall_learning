...
import net.zhaoxitong.mmall.common.TokenCache;
import net.zhaoxitong.mmall.dao.UserMapper;
import net.zhaoxitong.mmall.pojo.User;
import net.zhaoxitong.mmall.service.IUserService;
import net.zhaoxitong.mmall.util.MD5Util;
...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse<String> resetPassword(String passwordOld, String passwordNew, User user) {
        //防止横向越权，要校验一下这个用户的旧密码，一定要指定这个用户，查询一个count(1)
